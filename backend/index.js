...
import { createTrip, deleteTripDetails, getTripDetails } from './controllers/trips.controller.js';
import { addActivity, deleteActivity } from './controllers/itenary.controller.js';
import { createExpense, deleteExpenses, getExpenses, updateExpenses } from './controllers/expense.controller.js';
...
app.delete('/api/trips/:tripid/itenary/:activityid' , authentication , deleteActivity);
...
app.put('/api/trips/:tripid/expenses/:expenseId' , authentication , updateExpenses);
app.delete('/api/trips/:tripid/expenses/:expenseId' , authentication , deleteExpenses);
